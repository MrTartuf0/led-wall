...
export default {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.2LOOEazG.mjs').then(interopDefault),
  "pages/index.vue": () => import('./_nuxt/index-styles.Jnapx4bY.mjs').then(interopDefault),
